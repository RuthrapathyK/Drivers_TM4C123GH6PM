...
# Rules starts here
build: clean main.o startup.o uart.o pinconfig.o nvic.o common.o led.o out.elf out.bin out.hex out.s
...
out.elf:$(BUILD_FOLDER)/main.o $(BUILD_FOLDER)/startup.o $(BUILD_FOLDER)/uart.o $(BUILD_FOLDER)/pinconfig.o $(BUILD_FOLDER)/nvic.o $(BUILD_FOLDER)/common.o $(BUILD_FOLDER)/led.o
